...
class StreamAnalyzer:
    ...
    frequency_bin_energies: NDArray[np.float64]
    ...
    def __init__(
        ...
        self.data_windows_to_buffer = math.ceil(
            self.FFT_window_size / self.stream_reader.frames_per_buffer
        )
        ...
        if self.smoothing_length_ms > 0:
            ...
            self.feature_buffer = NumpyDataBuffer(
        ...
        self.rolling_bin_values = NumpyDataBuffer(
    ...
    def update_features(self, n_bins=3):
        ...
        latest_data_window = self.stream_reader.get_most_recent_data(
            self.FFT_window_size
        )
    ...
    def get_audio_features(self):
        ...
        if (
            self.stream_reader.has_new_data()
