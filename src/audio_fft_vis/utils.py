...
class Button:
    ...
    def __update__(self):
        ...
        self.pyg.draw.line(
            self.buttonHOVER, self.colour2, (2, 0), (self.width - 3, 0), 1
        )
        self.pyg.draw.line(
            self.buttonHOVER,
            self.colour2,
        ...
        self.pyg.draw.line(
            self.buttonHOVER, self.colour2, (0, 2), (0, self.height - 3), 1
        )
        self.pyg.draw.line(
            self.buttonHOVER, self.colour4, (1, 2), (1, self.height - 3), 2
        )
        self.pyg.draw.line(
            self.buttonHOVER,
            self.colour2,
        ...
        self.pyg.draw.line(
            self.buttonDOWN, self.colour2, (2, 0), (self.width - 3, 0), 1
        )
        self.pyg.draw.line(
            self.buttonDOWN, (r - 20, g - 20, b - 10), (2, 1), (self.width - 3, 1), 2
        )
        self.pyg.draw.line(
            self.buttonDOWN,
            self.colour2,
        ...
        self.pyg.draw.line(
            self.buttonDOWN, self.colour2, (0, 2), (0, self.height - 3), 1
        )
        self.pyg.draw.line(
            self.buttonDOWN, (r - 20, g - 20, b - 10), (1, 2), (1, self.height - 3), 2
        )
        self.pyg.draw.line(
            self.buttonDOWN,
            self.colour2,
